                ...
                <div className="relative z-10 flex flex-col md:flex-row justify-between items-center gap-8">
                    <div className="space-y-3">
                        <h1 className="text-5xl font-black text-black tracking-tighter uppercase italic">
                            Business <span className="text-blue-600">Entities</span>
                        </h1>
                        <p className="text-blue-300 text-sm font-bold uppercase tracking-[0.2em] flex items-center gap-4">
                            Structure and manage high-level corporate segments and multi-tenant nodes
                        </p>
                    </div>
                    <div className="flex gap-4">
                        <div className="bg-blue-50 px-8 py-5 rounded-[2rem] border-2 border-blue-100 flex flex-col items-end shadow-sm">
                            <span className="text-[10px] text-blue-300 uppercase tracking-widest font-black">Total Entities</span>
                            <span className="text-4xl font-black text-blue-600 tracking-tighter italic">{businesses.length}</span>
                        </div>
                    </div>
                </div>
            </div>
